...
OF isn’t a programming language in itself. The  language you use to write programs with OF is C++. OF is a software framework (see below) that uses C++ to program and make use of all the classes, methods addons that you will have available to you.
